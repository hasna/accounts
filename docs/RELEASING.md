...
entry. While 0.2.29's row was missing, three consecutive overrides appeared as
two non-adjacent ones separated by a normal release that never happened.
